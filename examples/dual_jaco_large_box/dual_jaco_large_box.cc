...
DEFINE_bool(test, false,
            "wheter this example is being run in test mode, whether we solve a"
            " simpler problem.");

namespace idto {
namespace examples {
namespace dual_jaco_large_box {
...
class DualJacoLargeBoxExample : public TrajOptExample {
 public:
  DualJacoLargeBoxExample() {
 ...
 private:
  void CreatePlantModel(MultibodyPlant<double>* plant) const final {
    ...
    // TODO(manabu-nishiura-tri): This is weired. Change internal controller 
    // to implicit pd controller.
  ...
  void CreatePlantModelForSimulation(
    ...
    plant->WeldFrames(plant->world_frame(),
                      plant->GetFrameByName("base", jaco_left), X_left);
    // TODO(manabu-nishiura-tri): modify to include gravity
    plant->set_gravity_enabled(jaco_left, false);
